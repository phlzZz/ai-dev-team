...
Everything you decide goes into that file too, not just the plan sections: the assumptions you had to make, the options you rejected and why, the risks you spotted along the way. Your reply to the orchestrating session is a **summary of `docs/plan.md`, never the only copy** (build review 2026-08-04 — a full Tier-2 plan existed only in the reply and had to be retyped into the project by hand).
